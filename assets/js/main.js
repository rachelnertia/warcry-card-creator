...
drawToughness = function(value) {
    writeScaled(value, {x: 257, y: 174}); // Default was x:257, y:174
}
...
function drawTagRunemark(index, runemark) {
    ...
    var positions = [{x: 550, y: 600}, {x: 750, y: 600}, {x: 650, y: 450}];
    ...
    position = scalePixelPosition({x: positions[index].x + 0, y: positions[index].y + 0});  // Default was +10
