...
render = function(fighterData) {
    ...
    {
        drawWeapon(fighterData.weapon1, {x: 53, y: 850}); // Default was x:29, y:397
        drawWeapon(fighterData.weapon2, {x: 53, y: 1050}); // Default was x:29, y:564
    }
    else if (fighterData.weapon1.enabled)
    {
        drawWeapon(fighterData.weapon1, {x: 53, y: 850}); // Default was x:29, y:463
    }
    else if (fighterData.weapon2.enabled)
    {
        drawWeapon(fighterData.weapon2, {x: 53, y: 850}); // Default was x:29, y:463
    }
